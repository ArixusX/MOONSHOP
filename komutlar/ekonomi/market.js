...
exports.run = (client, message, args, prefix) => {
    ...
    .setDescription(`
    • | Krediniz: \`${db.fetch(`goldkredi_${message.author.id}`) || 0} Coin\` <a:bitcoin:955119700503838751>
  ...
  • | Paket: **Ultra** - Süre: **Nitro Süresi 1 AY**
  • | Paket: **Ultra** - Süre: **Sınırsız**
    `, true)
    .addField("Satın Alma", `
    • | Komut: **${prefix}demir** - Fiyat: **5.000 Kredi**
	• | Komut: **${prefix}altın** - Fiyat: **15.000 Kredi**
	• | Komut: **${prefix}zümrüt** - Fiyat: **25.000 Kredi**
  • | Komut: **${prefix}nitro** - Fiyat: **250.000 Kredi**
  • | Komut: **${prefix}premium** - Fiyat: **350.000 Kredi**
    `, true)
    .addField("Özellikler", `
